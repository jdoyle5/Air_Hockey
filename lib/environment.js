...
var scorePlayer1 = 0, scorePlayer2 = 0, scorePlayer3 = 0, scorePlayer4 = 0;
...
function setScene() {
  ...
  strikerOne.position.x = -fieldWidth/2 + strikerWidth;
  strikerTwo.position.x = fieldWidth/2 - strikerWidth;

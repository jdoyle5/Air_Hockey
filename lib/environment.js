...
function setScene() {
  ...
  strikerOne.position.x = -gameStats.fieldWidth/2 + strikerBotRadius;
  strikerTwo.position.x = gameStats.fieldWidth/2 - strikerBotRadius;
...
function draw() {
  ...
  spotLight.position.x = puck.position.x * 2;
	...
	// camera.position.z = strikerOne.position.z + 100 + 0.04 * (-puck.position.x + strikerOne.position.x);
